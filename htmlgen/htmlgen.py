...
class HTMLgen:
    ...
    def renderSite(self, comments=False):
        ...
        for article in self.articles[::-1]:
            ...
            x=x-1
        if not comments:
            styleargs = {"title":self.title,"nav":nav,"main":main,"aside":self.asideHTML,"footer":"<a href=\"https://github.com/Mtgxyz2/homepage\">Design and Code by Morten Delenk</a> - <a href=\"https://creativecommons.org/licenses/by-sa/3.0/\">Content is released under CC-BY-SA</a>"}
        else:
            styleargs = {"title":self.title,"nav":nav,"main":self.asideHTML+main,"aside":"","footer":"<a href=\"https://github.com/Mtgxyz2/homepage\">Design and Code by Morten Delenk</a> - <a href=\"https://creativecommons.org/licenses/by-sa/3.0/\">Content is released under CC-BY-SA</a>"}
